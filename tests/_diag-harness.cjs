...
const THREE = new Proxy({
  Vector2: stubClass(), Vector3: function (x, y, z) { return vec3(x, y, z); }, Vector4: stubClass(), ShapeUtils: { triangulateShape(c) { const t=[]; for (let i=1;i+1<c.length;i++) t.push([0,i,i+1]); return t; } },
